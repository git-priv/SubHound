# subracer.core.tools
#
# Discovery of the external command-line tools subracer shells out to. The app is
...
@dataclass
class ToolStatus:
  # Availability of the external tools subracer uses, and where they came from.
  ffmpeg: str | None
  ffprobe: str | None
  ffsubsync: bool
...
# Function Summary:
#    Probe the environment for all external tools subracer uses, resolving
