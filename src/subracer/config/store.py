...
# Function Summary:
#    Return the path to subracer's config directory, creating it if needed.
#
#  Input (parameters):
#    (none)
#
#  Output:
#    path [Path]:  the per-user config directory for subracer
#
# Example:
#    config_dir()  ->  PosixPath("/home/priv/.config/subracer")
def config_dir() -> Path:
...
# Function Summary:
#    Return subracer's data directory (for the local OSDB, mirror, logs),
...
#
#  Output:
#    path [Path]:  the per-user data directory for subracer
#
# Example:
#    data_dir()  ->  PosixPath("/home/priv/.local/share/subracer")
def data_dir() -> Path:
...
#
# Example:
#    save_settings(Settings())  ->  PosixPath("/home/priv/.config/subracer/settings.toml")
