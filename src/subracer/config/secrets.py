...
# it just domain-separates subracer's key from anything else derived from the
# same machine id.
_APP_SALT = b"subracer/credentials/v1"
...
#
#  Input (parameters):
#    config_directory [Path]:  the subracer config directory
#
#  Output:
