...
# Function Summary:
#    Return the shared subracer logger.
#
#  Input (parameters):
#    (none)
#
#  Output:
#    logger [logging.Logger]:  the "subracer" logger
#
# Example:
...
#
# Example:
#    configure_logging(Path("/run/logs"), logging.INFO)  ->  PosixPath(".../subracer-20260615-101500.log")
def configure_logging(
  ...
  if log_dir is not None:
    ...
    log_path = log_dir / f"subracer-{datetime.now().strftime('%Y%m%d-%H%M%S')}.log"
