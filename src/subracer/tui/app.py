...
class SubracerApp(App):
    ...
    with TabbedContent(initial="run"):
      ...
      with TabPane("Run", id="run"):
        ...
        yield Static(
          ...
          "few downloads/day) is left, you can exit and let the OS re-run subracer "
  ...
  # Function Summary:
  #    Show (and optionally install) the OS scheduler entry that re-runs subracer
